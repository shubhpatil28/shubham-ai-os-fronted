        ...
        <header className="border-b border-[#00f3ff]/10 bg-slate-950/40 backdrop-blur-md px-6 py-4 flex items-center justify-between z-20">
          ...
          <div className="flex items-center gap-2 border border-slate-800 bg-slate-950/60 p-1 rounded-xl">
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-mono font-bold uppercase transition-all tracking-wider flex items-center gap-1.5 ${activeTab === 'core' ? 'bg-[#00f3ff]/10 text-[#00f3ff]' : 'text-slate-400 hover:text-white'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-mono font-bold uppercase transition-all tracking-wider flex items-center gap-1.5 ${activeTab === 'whatsapp' ? 'bg-emerald-500/10 text-emerald-400' : 'text-slate-400 hover:text-white'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-mono font-bold uppercase transition-all tracking-wider flex items-center gap-1.5 ${activeTab === 'memory' ? 'bg-[#bd00ff]/10 text-[#bd00ff]' : 'text-slate-400 hover:text-white'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-mono font-bold uppercase transition-all tracking-wider flex items-center gap-1.5 ${activeTab === 'builder' ? 'bg-cyan-400/10 text-cyan-400' : 'text-slate-400 hover:text-white'
                }`}
            >
